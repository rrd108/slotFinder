      ...
      <UCard>
        ...
        <div class="mt-4 p-3 bg-blue-50 rounded text-sm">
          ...
          <ol class="list-decimal list-inside space-y-1 text-gray-600">
            ...
            <li>
              Oszd meg a naptárat a <code class="bg-white px-1">{{ config.public.googleCalendarServiceEmail }}</code> címmel.
              <em> Csak az elfoglaltsági adatok megtekintése jogosultságot kell választani </em>, így nem látjuk mit csinálsz, csak azt, hogy foglalt vagy.
            </li>
          </ol>
        </div>
      </UCard>
      ...
      <UCard>
        ...
        <div class="space-y-3">
          <div class="flex flex-wrap gap-2 items-start">
            <USelect v-model="newAvailability.days" :items="dayOptions" placeholder="Nap" multiple class="w-full sm:w-48" />
            <USelect v-model="newAvailability.start_time" :items="timeOptions" placeholder="Kezdés" class="w-28" />
            <USelect v-model="newAvailability.end_time" :items="timeOptions" placeholder="Vég" class="w-28" />
          </div>
